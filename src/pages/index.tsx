  ...
  if (status === "authenticated") {
    return (
      <div className="bg-gradient-to-r from-pink-500 to-yellow-500 bg-cover">
        <NavBar user={data.user} signOut={signOut} />
          ...
          <div className="col-start-2">
            <div className="flex flex-col outline outline-2 rounded-xl p-2 bg-white shadow-2xl">
              ...
              <textarea
                id="message"
                rows="4"
                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-600 focus:ring-blue-500 focus:border-blue-500"
